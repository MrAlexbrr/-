...
# Функция для подсчета количества каждой буквы в порядке их появления
...
def calculate_frequency(letter_count):
    ...
    for letter, count in letter_count.items():
        frequency[letter] = count / total_letters  # Вычисляем частоту
    return frequency
...
# Вывод букв и их частоты в порядке появления
